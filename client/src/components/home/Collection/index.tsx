      ...
      <Carousel opts={{ loop: true }}>
        <CarouselContent>
          ...
          <CarouselItem>
            <div
              data-slide-index={1}
              className="flex items-center justify-center relative h-[450px] bg-cover bg-center-center overflow-hidden after:absolute after:h-full after:w-full after:left-0 after:top-0 after:bg-gradient-to-t from-black/70 to-black/10"
              style={{
